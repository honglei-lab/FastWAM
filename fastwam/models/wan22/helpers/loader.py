...
def _load_registered_model(
    ...
    # Fail closed: a pretrained component must never silently retain random tensors.
...
def _resolve_configs(model_id: str, tokenizer_model_id: str, redirect_common_files: bool = True):
    ...
    if redirect_common_files:
        # The local text encoder is distributed as the original PyTorch checkpoint.
        # Only the VAE needs the converted DiffSynth checkpoint.
